...
# the multifractal first-order DFA ('getMSSByUpscaling.py'). The initial dataset is a binomial cascade (see [1] for details)
# loaded from the file 'dx_init.txt'.
#
# References:
